...
export function NewAccountForm({ vaults }: { vaults: Vault[] }) {
    ...
    <main className="mx-auto flex min-h-screen max-w-md flex-col px-4 pb-8 pt-[max(0.5rem,env(safe-area-inset-top))]">
      ...
      <form action={formAction} className="mt-6 space-y-6">
        ...
        <div className="space-y-1.5">
          ...
          <select id="vaultId" name="vaultId" defaultValue={vaults[0]?.id ?? ''} className="ios-input">
